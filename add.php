<?php 
  ...
  if($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if(empty($_POST["name"]) || empty($_POST["phone_number"])) {
      ...
      $statement->bindParam(":user_id", $_SESSION["user"]["id"]);  // NO SQL injection
      $statement->bindParam(":name", $_POST["name"]);  // NO SQL injection
      $statement->bindParam(":phone_number", $_POST["phone_number"]); // NO SQL injection
      $statement->execute();
